package asslock.rust.Utils.FontUtils;
...
public class FontRenderer extends CFont {
    ...
    public FontRenderer(String NameFontTTF, int size, int fonttype, boolean antiAlias, boolean fractionalMetrics) {
        super(FontUtil.getFontFromTTF(new ResourceLocation("javarust/fonts/" + NameFontTTF+".ttf"), size,fonttype), antiAlias, fractionalMetrics);
        setupMinecraftColorcodes();
        setupBoldItalicIDs();
    }
