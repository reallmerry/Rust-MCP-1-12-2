package asslock.rust.Gui;

import asslock.rust.Client;
...
public class CustomMenu extends GuiScreen
{
    ...
    public static asslock.rust.Utils.FontUtils.FontRenderer RobotoCondensedbold = new FontRenderer("RobotoCondensed-Bold", 20, Font.PLAIN, true, true);
    public static asslock.rust.Utils.FontUtils.FontRenderer RobotoCondensedRegular = new FontRenderer("RobotoCondensed-Regular", 20, Font.PLAIN, true, true);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        RobotoCondensedRegular.drawString("Minecraft 1.12.2 hello?", 3, 200, Color.RED.getRGB());
